...
type TranslationMap = {
  ...
  // Reading display (cách hiện kết quả phân tích)
  readingDisplayTitle: string;
  readingDisplayDesc: string;
  readingDisplayBreakdown: string;
  readingDisplayPoker: string;
  // Phonetic system (hệ phiên âm)
  phoneticSystemTitle: string;
  phoneticSystemDesc: string;
  phoneticSystemDefault: string;
  phoneticSystemRomanization: string;
  phoneticSystemIpa: string;
  // Vocabulary
...
const translations: Record<Locale, TranslationMap> = {
  en: {
    ...
    readingDisplayTitle: 'Reading display',
    readingDisplayDesc: 'How syllable results appear on the Reading screen.',
    readingDisplayBreakdown: 'Breakdown',
    readingDisplayPoker: 'Poker cards',
    phoneticSystemTitle: 'Phonetics',
    phoneticSystemDesc: 'How pronunciation is written under Hangul syllables.',
    phoneticSystemDefault: 'Default',
    phoneticSystemRomanization: 'Romanization',
    phoneticSystemIpa: 'IPA',
    ...
    onboardingSlide1Body: 'Meet Hangmi, your tabby-cat study buddy (with a Hangul ㅎ on her forehead). Learn the alphabet, practice reading, grammar, vocabulary and smart review.',
    ...
    guideIntro: 'A quick overview of the main features — Hangmi will keep you company along the way. Each screen also shows a hint card on your first visit.',
  ...
  vi: {
    ...
    readingDisplayTitle: 'Hiển thị Đọc',
    readingDisplayDesc: 'Cách hiện kết quả âm tiết trên màn Đọc.',
    readingDisplayBreakdown: 'Phân tích',
    readingDisplayPoker: 'Thẻ poker',
    phoneticSystemTitle: 'Phiên âm',
    phoneticSystemDesc: 'Cách ghi phiên âm dưới các âm tiết Hangul.',
    phoneticSystemDefault: 'Mặc định',
    phoneticSystemRomanization: 'Romanization',
    phoneticSystemIpa: 'IPA',
    ...
    onboardingSlide1Body: 'Gặp Hangmi — mèo mướp đồng hành (vân ㅎ trên trán). Học bảng chữ cái, luyện đọc, ngữ pháp, từ vựng và ôn tập thông minh.',
    ...
    guideIntro: 'Tổng quan nhanh các tính năng chính — Hangmi sẽ đồng hành cùng bạn. Mỗi màn hình cũng có thẻ gợi ý khi bạn vào lần đầu.',
  ...
  zh: {
    ...
    readingDisplayTitle: '阅读显示',
    readingDisplayDesc: '阅读页音节结果的显示方式。',
    readingDisplayBreakdown: '拆分',
    readingDisplayPoker: '扑克牌',
    phoneticSystemTitle: '注音',
    phoneticSystemDesc: '韩语音节下方的注音方式。',
    phoneticSystemDefault: '默认',
    phoneticSystemRomanization: 'Romanization',
    phoneticSystemIpa: 'IPA',
    vocabLevelTitle: '等级',
    vocabNewWord: '生词',
    ...
    onboardingSlide1Body: '认识 Hangmi——额头带韩文 ㅎ 的狸花猫伙伴。学习字母、阅读练习、语法、词汇和智能复习。',
    ...
    guideTitle: '使用指南',
    guideIntro: '主要功能速览——Hangmi 会一路陪伴你。首次进入每个屏幕时也会显示提示卡。',
  ...
  hi: {
    ...
    readingDisplayTitle: 'पढ़ने का प्रदर्शन',
    readingDisplayDesc: 'पढ़ने की स्क्रीन पर अक्षर कैसे दिखें।',
    readingDisplayBreakdown: 'विभाजन',
    readingDisplayPoker: 'पोकर कार्ड',
    phoneticSystemTitle: 'उच्चारण',
    phoneticSystemDesc: 'हंगुल अक्षरों के नीचे उच्चारण कैसे लिखें।',
    phoneticSystemDefault: 'डिफ़ॉल्ट',
    phoneticSystemRomanization: 'Romanization',
    phoneticSystemIpa: 'IPA',
    ...
    onboardingSlide1Body: 'Hangmi से मिलें — माथे पर हंगुल ㅎ वाली टेबी बिल्ली साथी। वर्णमाला, पढ़ना, व्याकरण, शब्दावली और स्मार्ट दोहराव सीखें।',
    ...
    guideIntro: 'मुख्य सुविधाओं की झलक — Hangmi साथ रहेगी। पहली बार खोलने पर हर स्क्रीन पर संकेत कार्ड भी दिखता है।',
  ...
  es: {
    ...
    readingDisplayTitle: 'Vista de Lectura',
    readingDisplayDesc: 'Cómo se muestran las sílabas en la pantalla Lectura.',
    readingDisplayBreakdown: 'Desglose',
    readingDisplayPoker: 'Cartas de póker',
    phoneticSystemTitle: 'Fonética',
    phoneticSystemDesc: 'Cómo se escribe la pronunciación bajo las sílabas Hangul.',
    phoneticSystemDefault: 'Predeterminado',
    phoneticSystemRomanization: 'Romanization',
    phoneticSystemIpa: 'IPA',
    ...
    onboardingSlide1Body: 'Conoce a Hangmi, tu gata atigrada (con un ㅎ hangul en la frente). Aprende alfabeto, lectura, gramática, vocabulario y repaso inteligente.',
    ...
    guideIntro: 'Un repaso rápido de las funciones principales — Hangmi te acompaña. Cada pantalla también muestra una tarjeta de ayuda la primera vez.',
  ...
  fr: {
    ...
    readingDisplayTitle: 'Affichage Lecture',
    readingDisplayDesc: 'Comment les syllabes s’affichent sur l’écran Lecture.',
    readingDisplayBreakdown: 'Décomposition',
    readingDisplayPoker: 'Cartes poker',
    phoneticSystemTitle: 'Phonétique',
    phoneticSystemDesc: 'Comment la prononciation est écrite sous les syllabes Hangul.',
    phoneticSystemDefault: 'Par défaut',
    phoneticSystemRomanization: 'Romanization',
    phoneticSystemIpa: 'IPA',
    ...
    onboardingSlide1Body: 'Voici Hangmi, votre chat tigré (avec un ㅎ hangul sur le front). Alphabet, lecture, grammaire, vocabulaire et révision intelligente.',
    ...
    guideIntro: 'Un aperçu rapide des fonctions principales — Hangmi vous accompagne. Chaque écran affiche aussi une carte d’aide à la première visite.',
  ...
  ja: {
    ...
    readingDisplayTitle: '読み表示',
    readingDisplayDesc: '読み画面での音節の表示方法。',
    readingDisplayBreakdown: '分解',
    readingDisplayPoker: 'ポーカーカード',
    phoneticSystemTitle: '発音表記',
    phoneticSystemDesc: 'ハングル音節の下に出す発音の書き方。',
    phoneticSystemDefault: 'デフォルト',
    phoneticSystemRomanization: 'Romanization',
    phoneticSystemIpa: 'IPA',
    vocabLevelTitle: 'レベル',
    vocabNewWord: '単語',
    ...
    onboardingSlide1Body: 'Hangmiに会おう——おでこにハングル「ㅎ」のトラ猫パートナー。文字・読み・文法・語彙・スマート復習を学ぼう。',
    ...
    guideTitle: '使い方ガイド',
    guideIntro: '主な機能のクイックガイドです。Hangmiが一緒に寄り添います。各画面には初回訪問時にヒントカードも表示されます。',
